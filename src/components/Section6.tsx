  ...
  return (
    <div>
      <div className="flex flex-col gap-10 p-10">
        <div>
          <p className="text-4xl font-bold mb-2">Our Testimonials</p>
          <p>
        ...
        <div className="flex flex-wrap justify-around gap-5">
          <div className="flex w-3/4 lg:w-1/3 flex-col gap-3 border rounded-lg p-4">
            <p>
              ...
              becoming a doctor would have been much harder. Thank you, R. H.
              Sir, for your guidance and support!"
            </p>
            <div className="flex justify-between">
              ...
              <button type="button" className="bg-gray-300 rounded-lg p-2 px-5">
                Read Full Story
              </button>
            </div>
          </div>
          ...
          <div className="flex w-3/4 lg:w-1/3 flex-col gap-3 border rounded-lg p-4">
            <p>
              ...
              understand concepts better. Thanks to R. H. Sir and the entire
          ...
          <div className="flex w-3/4 lg:w-1/3  flex-col gap-3 border rounded-lg p-4">
            <p>
              ...
              combined with top-notch resources made it accessible for me to
              prepare thoroughly. The performance tracking feature helped me
              identify my weak areas and work on them diligently. I wouldn't
              have achieved my dream score without this platform!"
            </p>
            <div className="flex justify-between">
              <div className="flex w-fit gap-2">
                <div className="relative w-6 h-6">
